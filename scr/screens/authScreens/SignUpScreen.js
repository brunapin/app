...
const initialValues = {name:"",family_name:"", phone_number:'', password:"",email:'',username:''}
        ...
        <View style={styles.container}>
            ...
            <ScrollView keyboardShouldPersistTaps='always'>
                <View style={styles.view1}>
                    <Text style={styles.text1}>Novo Cadastro</Text>
                </View>
                <Formik initialValues={initialValues} onSumit = {(values)=>{signUp(values)}}>
                {(props)=>(
